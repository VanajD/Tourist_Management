...
<body>
    ...
    <form action="step2.php" method="GET">
        <input type="hidden" value="<?= isset($_GET['placeName']) ? $_GET['placeName'] : '' ?>" name="placeName">
        <input type="hidden" value="<?= isset($_GET['phoneNo']) ? $_GET['phoneNo'] : '' ?>" name="phoneNo">
        <input type="hidden" value="<?= isset($_GET['email']) ? $_GET['email'] : '' ?>" name="email">
        <input type="hidden" value="<?= isset($_GET['password']) ? $_GET['password'] : '' ?>" name="password">
